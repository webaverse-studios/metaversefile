...
const spritenpc = require('../types/spritenpc.js');
const loaders = {
  js: jsx,
  jsx,
  metaversefile,
...
const _getType = id => {
  ...
  if (o.href && (match = o.href.match(dataUrlRegex))) {
    ...
    let extension;
    let match2;
    if (match2 = type.match(/^application\/(light|text|rendersettings|spawnpoint|lore|quest|npc|mob|react|group|wind|vircadia|scene2D|spritenpc)$/)) {
      extension = match2[1];
